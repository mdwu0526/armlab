...
class RXArm(InterbotixRobot):
    ...
    def __init__(self, dh_config_file=None):
        ...
        if (dh_config_file is not None):
            self.dh_params = self.rx_arm_parse_dh_param_file()
        #POX params
        self.M_matrix = []
        self.S_list = []
    ...
    def get_ee_pose(self):
        ...
        final_trans = FK_dh(self.dh_params, joint_angles, 4)
        pose = get_pose_from_T(final_trans)
        return pose
    ...
    def get_wrist_pose(self):
        ...
        """
        joint_angles = self.get_positions()
        final_trans = FK_dh(self.dh_params, joint_angles, 2)
        pose = get_pose_from_T(final_trans)
        return pose
    ...
    def rx_arm_parse_dh_param_file(self):
